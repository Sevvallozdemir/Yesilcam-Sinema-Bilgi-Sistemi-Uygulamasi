...
namespace VeriTabaniFinalProjesi
{
    public partial class OyuncuEkleme : Form
    {
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into oyuncu(oyuncuid,sahneadi,gercekadi,dogumtarihi,cinsiyet,odulsayisi) values(@p1,@p2,@p3,@p4,@p5,@p6)", baglanti);
